...
with col_side:
    ...
    if uploaded:
        ...
        sido  = st.selectbox("시도 선택", sidos, label_visibility="collapsed", key="sido")
        ...
        gu     = st.selectbox("구군 선택", guguns, label_visibility="collapsed", key="gu")
        ...
        # 검색
        search = st.text_input("검색", placeholder="사업장명 검색...", label_visibility="collapsed")
